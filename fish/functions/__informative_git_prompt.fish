...
set -g fish_color_git_branch cyan
...
function __informative_git_prompt --description 'Write out the git prompt'
    ...
    printf " $color_normal(%s|%s)" (___fish_git_print_branch_info) $git_status_info
...
function ___fish_git_print_branch_info
    ...
    echo "$color_branch$branch$color_normal$remote_info$color_branch"
